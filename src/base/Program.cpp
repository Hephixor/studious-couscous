   ...
   while(current != NULL){   
	 ...
	 if(direct.size() !=0){
	    ...
	    if( direct.compare(0, 4, ".end")==0){
	       ...
	       element_debut=NULL;
	       func->comput_basic_block();
	       func->comput_succ_pred_BB();
	       //func -> display();
...
/* Pour chaque fonction du programme, donc de la liste _myfunc, il faut cr�er un CFG et l'ajouter � la liste _myCFG ;
   ...
   N'oubliez pas de calculer les blocs de base des fonctions et les succ/pred des BB sinon le CFG n'aura qu'un bloc, le premier (meme si on dit qu'il en a n en param�tre)
*/
